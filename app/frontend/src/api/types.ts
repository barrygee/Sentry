...
export interface paths {
    ...
    "/api/wired": {
        ...
        /**
         * Wired sharing's current configuration and state
         * @description Describe wired sharing, degrading rather than failing.
         *
         *     Always 200. A host with no NetworkManager answers `available: false` and a
         *     `nm_unavailable` warning — a client can therefore always render something
         *     truthful instead of an error it cannot explain.
         */
        get: operations["get_wired_api_wired_get"];
        /**
         * Replace the wired-sharing configuration
         * @description Write the whole configuration, then bring sharing up or down to match.
         */
        put: operations["put_wired_api_wired_put"];
        post?: never;
        /**
         * Delete the wired-sharing configuration
         * @description Forget the wired-sharing profile entirely.
         */
        delete: operations["delete_wired_api_wired_delete"];
        options?: never;
        head?: never;
        patch?: never;
        trace?: never;
    ...
    "/api/wired/clients": {
        ...
        /**
         * DHCP leases the wired share has issued
         * @description Return the share's leases, or `null` when they cannot be read.
         *
         *     `null` and `[]` are different answers and must stay so: one means "this host
         ...
         *     simply has no lease file.
         */
        get: operations["list_wired_clients_api_wired_clients_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/wired/clients/{mac_address}": {
        ...
        /**
         * Release one DHCP lease
         * @description Ask the share's DHCP server to forget one lease.
         *
         ...
         */
        delete: operations["release_wired_lease_api_wired_clients__mac_address__delete"];
        options?: never;
        head?: never;
        patch?: never;
        trace?: never;
    ...
    "/api/wired/confirm": {
        ...
        put?: never;
        /**
         * Keep the wired share that is awaiting confirmation
         * @description Cancel the pending rollback and let the share survive a reboot.
         *
         *     Reaching this route at all is the proof the commit-confirm flow wants: the
         *     API is still answering with the Pi's uplink port serving DHCP instead.
         */
        post: operations["confirm_wired_api_wired_confirm_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/wired/disable": {
        ...
        put?: never;
        /**
         * Stop the wired share
         * @description Bring the share down and stop it starting on boot.
         */
        post: operations["disable_wired_api_wired_disable_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/wired/enable": {
        ...
        put?: never;
        /**
         * Start the configured wired share
         * @description Bring the share up provisionally; it rolls back unless confirmed.
         *
         *     Separate from `PUT` so the UI's on/off switch never resends the whole
         *     configuration.
         */
        post: operations["enable_wired_api_wired_enable_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/wired/interfaces": {
        ...
        /**
         * Ethernet ports that could be shared
         * @description List candidate ports, flagging which one carries the host's own link.
         */
        get: operations["list_wired_interfaces_api_wired_interfaces_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
...
export interface components {
    schemas: {
        ...
        /**
         * WiredClientItem
         * @description One DHCP lease issued by the wired share.
         */
        WiredClientItem: {
            /**
             * Expired
         ...
         * @description `GET /api/wired/clients` body.
         *
         *     `clients` is `null`, never `[]`, when no lease file could be read — "we
        ...
        WiredClientsResponse: {
            /** Clients */
            clients?: components["schemas"]["WiredClientItem"][] | null;
            /**
             * Generated At
             * @description Unix ms
             */
        ...
        /**
         * WiredInterfaceItem
         * @description One selectable Ethernet port in `GET /api/wired/interfaces`.
         */
        WiredInterfaceItem: {
            /**
             * Carrier Up
             * @description Whether a cable is plugged in; null when unreported
             */
            ...
            /**
             * In Use By
             * @description Another connection currently active on this port, if any. Null when the port is idle, or when the only thing using it is this Sentry's own share.
             */
         ...
         * @description `GET /api/wired/interfaces` body. Empty when nothing can be enumerated.
         */
        WiredInterfacesResponse: {
            /**
             * Generated At
             ...
             * @default []
             */
            interfaces: components["schemas"]["WiredInterfaceItem"][];
        };
        /**
         * WiredShareActivationRequest
         * @description Body shared by `POST /api/wired/enable` and `/disable`.
         *
         *     These exist as their own routes so the UI's on/off switch never resends the
         *     whole configuration.
         */
         ...
         * @description `PUT /api/wired` body — a full replace, not a merge.
         *
        ...
        WiredShareConfigRequest: {
            /**
             * Confirm Uplink Loss
             * @description Acknowledges that the chosen port currently carries a connection which sharing it will drop
             * @default false
             */
            confirm_uplink_loss: boolean;
            /**
             * Enabled
             * @description Whether wired sharing should be running after this call
             * @default false
             */
            enabled: boolean;
            /**
             * Gateway Cidr
             * @description The Pi's address on the shared network; omit to use the configured default. Must not overlap the hotspot's range
             */
            gateway_cidr?: string | null;
            /**
             * Interface
             * @description Ethernet port to share; omit to choose an unused one automatically. On a single-port Pi there is no unused one, so this must name the port explicitly
             */
            interface?: string | null;
        };
        /**
         * WiredShareErrorSummary
         * @description The last control failure, kept so the UI can explain a share that is not up.
         */
        WiredShareErrorSummary: {
            /** Code */
            code: string;
            ...
            /**
             * Stderr Tail
             * @description Tail of the failing command's output. The only thing that says why NetworkManager refused
             */
            stderr_tail?: string | null;
            /**
             * Ts
         ...
         * @description `GET /api/wired` and every mutator's success body.
         *
         *     Never 503s: a host that cannot do any of this answers 200 with
        ...
        WiredShareStateResponse: {
            /**
             * Active
             * @description Whether wired sharing is running right now
             */
            active: boolean;
            /**
             * Available
             * @description Whether wired-sharing control works on this host
             */
            available: boolean;
            /**
             * Carrier Up
             * @description Whether a cable is plugged into the shared port. Null means the host did not report it — which is not the same as 'unplugged'
             */
            carrier_up?: boolean | null;
            /**
             * Configured
             * @description Whether a wired-sharing profile exists
             */
            configured: boolean;
            /**
             * Confirm Deadline Ms
             * @description Unix ms by which POST /api/wired/confirm must arrive
             */
            confirm_deadline_ms?: number | null;
            /**
             * Console Password Set
             * @description Whether a console password has been set
             */
            console_password_set: boolean;
            /**
             * Control Enabled
             * @description Whether host-network control is switched on. The same switch the hotspot uses — it grants the one capability both features need
             */
            control_enabled: boolean;
            /**
             * Enabled
            ...
            /** Interface */
            interface?: string | null;
            last_error?: components["schemas"]["WiredShareErrorSummary"] | null;
            /**
             * Pending Confirmation
            ...
            pending_confirmation: boolean;
            /**
             * Uplink Interface Is Share Interface
             * @description True when sharing this port would drop (or has dropped) the Pi's own link
             * @default false
             */
            uplink_interface_is_share_interface: boolean;
            /**
             * Warnings
             * @default []
             */
            warnings: ("console_password_missing" | "advertised_host_overrides_gateway" | "shares_uplink_port" | "no_carrier" | "nm_unavailable")[];
        };
        /**
...
export interface operations {
    ...
    get_wired_api_wired_get: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["WiredShareStateResponse"];
                };
            };
        };
    };
    put_wired_api_wired_put: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["WiredShareConfigRequest"];
            };
        };
        responses: {
            /** @description Successful Response */
    ...
    list_wired_clients_api_wired_clients_get: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["WiredClientsResponse"];
                };
            };
        };
    };
    release_wired_lease_api_wired_clients__mac_address__delete: {
        parameters: {
            query?: never;
            header?: never;
            path: {
    ...
    confirm_wired_api_wired_confirm_post: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    disable_wired_api_wired_disable_post: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["WiredShareActivationRequest"];
            };
        };
        responses: {
            /** @description Successful Response */
    ...
    enable_wired_api_wired_enable_post: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    list_wired_interfaces_api_wired_interfaces_get: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["WiredInterfacesResponse"];
                };
            };
        };
    };
