...
<template>
  <div class="flex flex-col">
    ...
    <label
      :for="fieldId"
      class="mb-1 block select-none font-sans text-[9px] font-bold uppercase tracking-control text-ink-primary"
    >
      {{ label }}
    </label>
    <input
      ...
      class="min-h-[24px] w-full min-w-0 rounded-rack border-none bg-transparent px-0 text-[12px] font-normal leading-[24px] font-tabular tracking-label text-ink-primary caret-ink-primary outline-none shadow-[inset_0_-1px_0_theme(colors.ground.hairline)] transition-shadow focus:shadow-[inset_0_-2px_0_theme(colors.signal.accent)] disabled:cursor-not-allowed disabled:opacity-40"
