 ...
 */
withDefaults(defineProps<{ title: string; detail?: string | null }>(), { detail: null })
</script>
...
<template>
  ...
  >
    <p class="font-sans text-[11px] font-semibold uppercase tracking-control text-signal-muted">
      {{ title }}
    </p>
